...
enum OpType {
  ...
  OpType_Landmarks2TransformMatrix = 156,
  OpType_TransformTensorBilinear = 157,
  OpType_TransformLandmarks = 158,
  OpType_Plugin = 256,
  OpType_Select = 257,
